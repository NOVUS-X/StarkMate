...
const Footer: FC = () => {
  ...
  return (
    <footer className="bg-gray-900 border-t border-cyan-500/20 pt-12 pb-6 relative">
      {/* Glow effect */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              The premier platform for competitive gaming on StarkNet. Play, compete, and earn in a secure and decentralized environment.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <p className="text-gray-400 text-sm">
                Join our community to stay updated on the latest tournaments and features.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="p-6 rounded-xl bg-gray-800/50 border border-gray-700 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="relative">
              <div className="text-center mb-4">
                ...
                <p className="text-gray-400 text-sm">
                  Subscribe to our newsletter for updates on tournaments and new features
                </p>
              </div>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <Link href="/terms" aria-label="Terms of Service" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">
              Terms of Service
            </Link>
            <Link href="/privacy" aria-label="Privacy Policy" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/faq" aria-label="FAQ" className="text-gray-500 hover:text-gray-300 text-sm transition-colors">
              FAQ
            </Link>
          </div>
        </div>
