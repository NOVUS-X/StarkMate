        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              {features.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors ${
                    index === activeFeature ? "bg-blue-500" : "bg-gray-700"
                  }`}
                />
              ))}
            </div>
          ...
          <div className="hidden lg:flex flex-col gap-4 w-1/3">
            {features.map((feature, index) => (
              <div
                key={feature.id}
                className={`p-6 rounded-2xl cursor-pointer transition-all duration-300 border border-gray-800 hover:border-gray-700 ${
                  activeFeature === index
                    ? `bg-gradient-to-r ${feature.color} shadow-lg shadow-${
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`p-3 rounded-xl bg-gray-800 ${
                      activeFeature === index ? "bg-opacity-30" : ""
                    }`}
                  >
                    {feature.icon}
                  </div>
                          ...
                          return (
                            <div
                              ...
                              className={`aspect-square ${
                                isBlack ? "bg-gray-700" : "bg-gray-600"
                              } rounded relative`}
                            >
