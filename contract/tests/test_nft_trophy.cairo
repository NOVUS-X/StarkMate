...
use contract::ntf_trophy::{ISoulboundTrophyDispatcher, ISoulboundTrophyDispatcherTrait, TrophyDetails};

// Helper function to deploy the SoulboundTrophy contract
fn deploy_soulbound_contract(owner: ContractAddress, name: felt252, symbol: felt252) -> (ISoulboundTrophyDispatcher, IERC721Dispatcher) {
    ...
    (
        ISoulboundTrophyDispatcher { contract_address },
