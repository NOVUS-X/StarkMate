...
pub trait IMatchStaking<TContractState> {
    fn create_match(ref self: TContractState, match_id: felt252, player1: ContractAddress, wager_amount: u256) -> bool;
...
pub mod MatchStaking {
    ...
    use super::{Match, IERC20Dispatcher, IERC20DispatcherTrait};
    ...
    impl MatchStakingImpl of super::IMatchStaking<ContractState> {
        fn create_match(
            ...
            assert(caller == player1 || self.ownable.owner() == caller, 'Caller must be player1 or owner');
            ...
            let token_address: ContractAddress = 0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d.try_into().unwrap();
        ...
        fn join_match(
            ...
            let caller = get_caller_address();
            assert(caller == player2 || self.ownable.owner() == caller, 'Caller must be player2 or owner');
            ...
            let transfer_success = erc20.transferFrom(player2, contract_address, match_data.wager_amount);
            assert(transfer_success, 'Token transfer failed');
        ...
        fn cancel_match(
            ...
            assert(
                ...
                (caller == match_data.player2 && match_data.player2 != contract_address_const::<0>()) || 
